    ...
    <div className="space-y-16 pb-16">
      <section className="hero-shell p-8 sm:p-10 lg:p-12">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-ink-900/70">
          We help you get genuine medicine from a licensed branch near you, whether you want
          delivery or prefer to pick it up yourself.
        </p>
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <article className="surface-card p-7 sm:p-8">
          ...
          <p className="mt-4 text-sm leading-7 text-ink-900/75">
            Every medicine we sell is NAFDAC-registered and comes through a licensed pharmacy. For
            prescription medicines, a licensed pharmacist checks the prescription before we prepare
            the order.
          </p>
          <p className="mt-4 text-sm leading-7 text-ink-900/75">
            You also see real prices and stock from your chosen branch before you pay.
          </p>
        </article>
        ...
        <article className="relative overflow-hidden rounded-[28px] bg-[linear-gradient(150deg,#062f2d,#0f3b39_55%,#0d9488)] p-7 text-white shadow-lift sm:p-8">
          ...
          <div className="relative">
            ...
            <div className="mt-6 grid gap-4">
              {[
                ['Genuine medicines', 'NAFDAC-registered and sold through licensed branches.'],
                ['A real pharmacist', 'Prescriptions are checked before the order is prepared.'],
      ...
      <section>
        <SectionTitle
          ...
          copy="Genuine medicine, real pharmacists, clear prices, and fast delivery."
        />
