...
export function CartLink() {
  ...
  return (
    <Link
      ...
      className={`inline-flex min-h-[3rem] items-center gap-3 rounded-2xl border px-4 py-2.5 text-sm font-semibold transition duration-300 ${
        count > 0
          ? 'border-ink-950 bg-ink-950 text-white shadow-[0_18px_34px_-22px_rgba(11,33,28,0.9)] hover:-translate-y-0.5 hover:bg-brand-800'
            : 'border-paper-200/90 bg-white/90 text-ink-800 shadow-sm backdrop-blur-sm hover:-translate-y-0.5 hover:border-brand-200 hover:text-brand-800'
      }`}
    >
      <span
